...
class MujocoViewer:
    def __init__(self, model, dt):
        ...
        self.frames = 0
        self.loop_count = 0
        self.target_render_time = 1 / 60.0
    ...
    def mouse_move(self, window, x_pos, y_pos):
        ...
        mujoco.mjv_moveCamera(
            self.model, action, dx / width, dy / height, self.scene, self.camera
        )
    ...
    def render(self, data):
        def render_inner_loop():
            ...
            if not self.hide_menu:
                for gridpos, (left_text, right_text) in self.overlay.items():
                    mujoco.mjr_overlay(
    ...
    def create_overlay(self):
        ...
        self.overlay[bottomright] = (
            "Framerate:",
            str(int(1 / self.time_per_render * self.run_speed_factor)),
        )
        ...
        self.overlay[topleft] = (
            self.overlay[topleft][0]
            + ("Run speed = %.3f x real time" % self.run_speed_factor),
