#!/usr/bin/env python3
"""
Submit DMC (mujoco_playground) experiments for REPPO (without DIME)
"""
...
def submit_job(
    ...
    cmd = [
        "sbatch", 
        f"--job-name=reppo_{env_name}_seed{seed}",
        "slurm/run_reppo_dmc.sh"
    ]
...
def main():
    parser = argparse.ArgumentParser(
        description="Submit DMC experiments for REPPO",
    ...
    print("=" * 80)
    print("DMC REPPO Job Submission")
    print("=" * 80)
