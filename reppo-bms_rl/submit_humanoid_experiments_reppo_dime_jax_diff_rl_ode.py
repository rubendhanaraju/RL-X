#!/usr/bin/env python3
"""
Submit DMC (mujoco_playground) experiments for REPPO-DIME with JAX Diff RL
"""
...
MAIN_FILE = "src/jaxrl/reppo_dime_jax_diff_rl.py"
...
CONFIGS = ["reppo_dime_jax_diff_rl_ode"]
OVERRIDES = [
...
# W&B settings
WANDB_ENTITY = "huylb314"
WANDB_PROJECT = "REPPO_DIME_JAX_DIFF_RL"
...
def submit_job(
    ...
    cmd = [
        "sbatch", 
        f"--job-name=reppo_dime_jax_diff_rl_{env_name}_seed{seed}",
        "slurm/run_reppo_dime_dmc_prod.sh"
    ]
...
def main():
    parser = argparse.ArgumentParser(
        description="Submit DMC experiments for REPPO-DIME with JAX Diff RL",
    ...
    print("=" * 80)
    print("DMC REPPO-DIME JAX Diff RL Job Submission")
    print("=" * 80)
