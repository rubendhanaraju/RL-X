...
### Kluster
#SBATCH --output=/home/i53/mitarbeiter/thilges/rl-soc/reppo/outputs/002_bms_dual_geom_avg_dmc/%x_%A_%a.out
#SBATCH --error=/home/i53/mitarbeiter/thilges/rl-soc/reppo/outputs/002_bms_dual_geom_avg_dmc/%x_%A_%a.err
...
# SWEEP Params
# ==============================================================================
BASE_OVERRIDE="-cn reppo_ve +run=002_bms_dual_geom_avg_dmc/config"
...
# Run your command
uv run src/jaxrl/reppo_ve_seperate_entropy_bound.py $CURRENT_PARAMS