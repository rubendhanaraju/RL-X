...
### Kluster
#SBATCH --output=/home/i53/mitarbeiter/thilges/rl-soc/reppo/outputs/008_clip_targetcritic_fingerhopper/%x_%A_%a.out
#SBATCH --error=/home/i53/mitarbeiter/thilges/rl-soc/reppo/outputs/008_clip_targetcritic_fingerhopper/%x_%A_%a.err
...
# SWEEP Params
# ==============================================================================
BASE_OVERRIDE="-cn reppo_pis +run=008_clip_targetcritic_fingerhopper/config"
...
JOBS_PER_TASK=8 # entire list_params
