...
#SBATCH --time=120 # in min (5 sequential runs x 60 min each)
...
### HAICORE
##SBATCH --output=/home/anthropomatik/nl7966/diffusion_reppo/reppo/outputs/%x_%A_%a.out
##SBATCH --error=/home/anthropomatik/nl7966/diffusion_reppo/reppo/outputs/%x_%A_%a.err

## HAICORE A100
##SBATCH --gres=gpu:full:1
##SBATCH --gres=gpu:1g.5gb:1
##SBATCH --cpus-per-task=32
##SBATCH --mem=125400 # in MB
...
# SWEEP Params
# ==============================================================================
BASE_OVERRIDE="-cn reppo_pis +run=009_pis_erfsquash_me_dmc_ENTtarget_batchRep/config"
...
GRID_KEYS=("seed" "env.name" "hyperparameters.diffusion.noise_schedule.sigma_max" "hyperparameters.ent_target_mult" "hyperparameters.Q_score_max_percentile" "hyperparameters.batch_repetitions")
