...
#SBATCH --array=0-39%0
#SBATCH --time=240 # in min

# uncomment from ##SBATCH to just #SBATCH depending on cluster

### Horeka
##SBATCH --output=/hkfs/work/workspace/scratch/km6079-diffrl/reppo/outputs/036_mjx_dualdescent/%x_%A_%a.out
##SBATCH --error=/hkfs/work/workspace/scratch/km6079-diffrl/reppo/outputs/036_mjx_dualdescent/%x_%A_%a.err
...
### HAICORE
##SBATCH --output=/hkfs/work/workspace_haic/scratch/km6079-diffrl/reppo/outputs/036_mjx_dualdescent/%x_%A_%a.out
##SBATCH --error=/hkfs/work/workspace_haic/scratch/km6079-diffrl/reppo/outputs/036_mjx_dualdescent/%x_%A_%a.err
...
### Juwels
#SBATCH --output=/p/home/jusers/thilges1/juwels/PROJECT_hai_1311/thilges/diffrl/reppo/outputs/036_mjx_dualdescent/%x_%A_%a.out
#SBATCH --error=/p/home/jusers/thilges1/juwels/PROJECT_hai_1311/thilges/diffrl/reppo/outputs/036_mjx_dualdescent/%x_%A_%a.err
...
### Kluster
##SBATCH --output=/home/i53/mitarbeiter/thilges/rl-soc/reppo/outputs/036_mjx_dualdescent/%x_%A_%a.out
##SBATCH --error=/home/i53/mitarbeiter/thilges/rl-soc/reppo/outputs/036_mjx_dualdescent/%x_%A_%a.err
...
# SWEEP Params
# ==============================================================================
BASE_OVERRIDE="-cn reppo_pis +run=036_mjx_dualdescent/config"
...
export WANDB_DIR=/p/home/jusers/thilges1/juwels/PROJECT_hai_1311/thilges/diffrl/reppo/outputs/036_mjx_dualdescent/ # for juwels
mkdir -pv $WANDB_DIR
