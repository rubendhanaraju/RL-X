...
### Horeka
##SBATCH --output=/hkfs/work/workspace/scratch/km6079-diffrl/reppo/outputs/012_maniskill_base/%x_%A_%a.out
##SBATCH --error=/hkfs/work/workspace/scratch/km6079-diffrl/reppo/outputs/012_maniskill_base/%x_%A_%a.err
...
### Kluster
#SBATCH --output=/home/i53/mitarbeiter/thilges/rl-soc/reppo/outputs/012_maniskill_base/%x_%A_%a.out
#SBATCH --error=/home/i53/mitarbeiter/thilges/rl-soc/reppo/outputs/012_maniskill_base/%x_%A_%a.err
...
# SWEEP Params
# ==============================================================================
BASE_OVERRIDE="-cn reppo_pis +run=012_maniskill_base/config"

# --- GRID SEARCH ---
# Define keys and then matching arrays named GRID_VALS_0, GRID_VALS_1, etc.

GRID_KEYS=("seed" "env.name" "hyperparameters.ent_target_mult" "hyperparameters.Q_score_max_percentile")
...
GRID_VALS_2=(1.0 1.5 2.0)
GRID_VALS_3=(95.0 80.0)
