...
#SBATCH --array=0-10%0
#SBATCH --time=1440 # in min

# uncomment from ##SBATCH to just #SBATCH depending on cluster

### Horeka
##SBATCH --output=/hkfs/work/workspace/scratch/km6079-diffrl/reppo/outputs/019_hb_eval/%x_%A_%a.out
##SBATCH --error=/hkfs/work/workspace/scratch/km6079-diffrl/reppo/outputs/019_hb_eval/%x_%A_%a.err
...
### HAICORE
##SBATCH --output=/hkfs/work/workspace_haic/scratch/km6079-diffrl/reppo/outputs/019_hb_eval/%x_%A_%a.out
##SBATCH --error=/hkfs/work/workspace_haic/scratch/km6079-diffrl/reppo/outputs/019_hb_eval/%x_%A_%a.err
...
### Juwels
#SBATCH --output=/p/home/jusers/thilges1/juwels/PROJECT_hai_1311/thilges/diffrl/reppo/outputs/019_hb_eval/%x_%A_%a.out
#SBATCH --error=/p/home/jusers/thilges1/juwels/PROJECT_hai_1311/thilges/diffrl/reppo/outputs/019_hb_eval/%x_%A_%a.err
...
### Kluster
##SBATCH --output=/home/i53/mitarbeiter/thilges/rl-soc/reppo/outputs/019_hb_eval/%x_%A_%a.out
##SBATCH --error=/home/i53/mitarbeiter/thilges/rl-soc/reppo/outputs/019_hb_eval/%x_%A_%a.err
...
# SWEEP Params
# ==============================================================================
#BASE_OVERRIDE="-cn reppo_pis_geomkl_torch +run=019_hb_eval/config"
BASE_OVERRIDE="-cn reppo_pis_geomkl_torch +run=019_hb_eval/config wandb.mode=offline hyperparameters.num_subproc=8" # for juwels

# --- GRID SEARCH ---
# Define keys and then matching arrays named GRID_VALS_0, GRID_VALS_1, etc.

GRID_KEYS=("seed")
GRID_VALS_0=(0 1 2) # TODO 3-9

# --- LIST SEARCH (Zipped/Sequential) ---
# Each index 'i' across these arrays forms one experiment
    # "h1hand-stand-v0" # 1000
    # "h1hand-walk-v0" # 1000
    # "h1hand-run-v0" # 1000
    # "h1hand-kitchen-v0" # 500, broken
    # "h1hand-maze-v0" # 1000
    # "h1hand-hurdle-v0" # 1000
    # "h1hand-cube-v0" # 500
    # "h1hand-bookshelf_simple-v0" # 1000
    # "h1hand-bookshelf_hard-v0" # 1000
    # "h1hand-highbar_simple-v0" # 1000, broken
    # "h1hand-highbar_hard-v0" # 1000, broken
    # "h1hand-crawl-v0" # 1000
    # "h1hand-window-v0" # 1000
    # "h1hand-spoon-v0" # 1000
    # "h1hand-door-v0" # 1000
    # "h1hand-push-v0" # 500
    # "h1hand-reach-v0" # 1000
    # "h1hand-basketball-v0" # 500
    # "h1hand-truck-v0" # 1000
    # "h1hand-package-v0" # 1000
    # "h1hand-cabinet-v0" # 1000
    # "h1hand-sit_simple-v0" # 1000
    # "h1hand-sit_hard-v0" # 1000
    # "h1hand-balance_simple-v0" # 1000
    # "h1hand-balance_hard-v0" # 1000
    # "h1hand-stair-v0" # 1000
    # "h1hand-slide-v0" # 1000
    # "h1hand-pole-v0" # 1000
    # "h1hand-room-v0" # 1000
    # "h1hand-insert_normal-v0" # 500
    # "h1hand-insert_small-v0" # 500
    # "h1hand-powerlift-v0" # 1000
...
# )
ABLATION_OVERRIDES=(
    "hyperparameters.diffusion.noise_schedule.sigma_min=0.1"
)
...
export WANDB_DIR=/p/home/jusers/thilges1/juwels/PROJECT_hai_1311/thilges/diffrl/reppo/outputs/019_hb_eval/ # for juwels
mkdir -pv $WANDB_DIR
...
for (( i=START_IDX; i<END_IDX && i<TOTAL_COUNT; i++ )); do
    ...
    # HYDRA_FULL_ERROR=1 uv run src/torchrl/reppo_pis_separate_geomkl.py $CURRENT_PARAMS
    HYDRA_FULL_ERROR=1 srun --ntasks=1 --exclusive uv run src/torchrl/reppo_pis_separate_geomkl.py $CURRENT_PARAMS & # for juwels
