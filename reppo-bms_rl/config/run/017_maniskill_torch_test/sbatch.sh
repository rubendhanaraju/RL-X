...
#SBATCH --array=0-135%8
#SBATCH --time=720 # in min

# uncomment from ##SBATCH to just #SBATCH depending on cluster

### Horeka
##SBATCH --output=/hkfs/work/workspace/scratch/km6079-diffrl/reppo/outputs/017_maniskill_torch_test/%x_%A_%a.out
##SBATCH --error=/hkfs/work/workspace/scratch/km6079-diffrl/reppo/outputs/017_maniskill_torch_test/%x_%A_%a.err
...
### Kluster
#SBATCH --output=/home/i53/mitarbeiter/thilges/rl-soc/reppo/outputs/017_maniskill_torch_test/%x_%A_%a.out
#SBATCH --error=/home/i53/mitarbeiter/thilges/rl-soc/reppo/outputs/017_maniskill_torch_test/%x_%A_%a.err
...
# SWEEP Params
# ==============================================================================
BASE_OVERRIDE="-cn reppo_pis_geomkl_torch +run=017_maniskill_torch_test/config"

# --- GRID SEARCH ---
# Define keys and then matching arrays named GRID_VALS_0, GRID_VALS_1, etc.

GRID_KEYS=("seed" "hyperparameters.diffusion.score_model.layer_norm" "hyperparameters.diffusion.noise_schedule.sigma_min")
GRID_VALS_0=(0 1)
GRID_VALS_1=("True" "False")
GRID_VALS_2=(0.01 0.1)
...
# )
ABLATION_OVERRIDES=(
    "hyperparameters.polyak=0.95"
    "hyperparameters.Q_score_max_percentile=95.0"
)
