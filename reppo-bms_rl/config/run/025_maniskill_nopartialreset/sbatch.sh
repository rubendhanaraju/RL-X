...
#SBATCH --array=0-29%0
#SBATCH --time=960 # in min

# uncomment from ##SBATCH to just #SBATCH depending on cluster

### Horeka
##SBATCH --output=/hkfs/work/workspace/scratch/km6079-diffrl/reppo/outputs/025_maniskill_nopartialreset/%x_%A_%a.out
##SBATCH --error=/hkfs/work/workspace/scratch/km6079-diffrl/reppo/outputs/025_maniskill_nopartialreset/%x_%A_%a.err
...
### HAICORE
##SBATCH --output=/hkfs/work/workspace_haic/scratch/km6079-diffrl/reppo/outputs/025_maniskill_nopartialreset/%x_%A_%a.out
##SBATCH --error=/hkfs/work/workspace_haic/scratch/km6079-diffrl/reppo/outputs/025_maniskill_nopartialreset/%x_%A_%a.err
...
### Juwels
##SBATCH --output=/p/home/jusers/thilges1/juwels/PROJECT_hai_1311/thilges/diffrl/reppo/outputs/025_maniskill_nopartialreset/%x_%A_%a.out
##SBATCH --error=/p/home/jusers/thilges1/juwels/PROJECT_hai_1311/thilges/diffrl/reppo/outputs/025_maniskill_nopartialreset/%x_%A_%a.err
...
### Kluster
#SBATCH --output=/home/i53/mitarbeiter/thilges/rl-soc/reppo/outputs/025_maniskill_nopartialreset/%x_%A_%a.out
#SBATCH --error=/home/i53/mitarbeiter/thilges/rl-soc/reppo/outputs/025_maniskill_nopartialreset/%x_%A_%a.err
...
# SWEEP Params
# ==============================================================================
BASE_OVERRIDE="-cn reppo_pis_geomkl_torch +run=025_maniskill_nopartialreset/config env.partial_reset=False"

# --- GRID SEARCH ---
# Define keys and then matching arrays named GRID_VALS_0, GRID_VALS_1, etc.

GRID_KEYS=("seed")
GRID_VALS_0=(0 1 2 3 4) # TODO 1-9
