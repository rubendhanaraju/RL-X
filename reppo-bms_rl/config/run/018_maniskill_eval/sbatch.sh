...
### Horeka
#SBATCH --output=/hkfs/work/workspace/scratch/km6079-diffrl/reppo/outputs/018_maniskill_eval/%x_%A_%a.out
#SBATCH --error=/hkfs/work/workspace/scratch/km6079-diffrl/reppo/outputs/018_maniskill_eval/%x_%A_%a.err
...
### Kluster
##SBATCH --output=/home/i53/mitarbeiter/thilges/rl-soc/reppo/outputs/018_maniskill_eval/%x_%A_%a.out
##SBATCH --error=/home/i53/mitarbeiter/thilges/rl-soc/reppo/outputs/018_maniskill_eval/%x_%A_%a.err
...
# SWEEP Params
# ==============================================================================
BASE_OVERRIDE="-cn reppo_pis_geomkl_torch +run=018_maniskill_eval/config"

# --- GRID SEARCH ---
# Define keys and then matching arrays named GRID_VALS_0, GRID_VALS_1, etc.

GRID_KEYS=("seed" "hyperparameters.diffusion.noise_schedule.sigma_min")
GRID_VALS_0=(0) # TODO 1-9
