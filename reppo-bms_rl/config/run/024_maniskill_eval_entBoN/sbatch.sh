...
#SBATCH --array=0-129%0
#SBATCH --time=480 # in min

# uncomment from ##SBATCH to just #SBATCH depending on cluster

### Horeka
#SBATCH --output=/hkfs/work/workspace/scratch/km6079-diffrl/reppo/outputs/024_maniskill_eval_entBoN/%x_%A_%a.out
#SBATCH --error=/hkfs/work/workspace/scratch/km6079-diffrl/reppo/outputs/024_maniskill_eval_entBoN/%x_%A_%a.err
...
### Kluster
##SBATCH --output=/home/i53/mitarbeiter/thilges/rl-soc/reppo/outputs/024_maniskill_eval_entBoN/%x_%A_%a.out
##SBATCH --error=/home/i53/mitarbeiter/thilges/rl-soc/reppo/outputs/024_maniskill_eval_entBoN/%x_%A_%a.err
...
# SWEEP Params
# ==============================================================================
BASE_OVERRIDE="-cn reppo_pis_geomkl_torch +run=024_maniskill_eval_entBoN/config"
