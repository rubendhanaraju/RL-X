...
#SBATCH --array=0-15%0
#SBATCH --time=480 # in min

# uncomment from ##SBATCH to just #SBATCH depending on cluster

### Horeka
##SBATCH --output=/hkfs/work/workspace/scratch/km6079-diffrl/reppo/outputs/028_mjx_hum_32steps_extend/%x_%A_%a.out
##SBATCH --error=/hkfs/work/workspace/scratch/km6079-diffrl/reppo/outputs/028_mjx_hum_32steps_extend/%x_%A_%a.err
...
### HAICORE
##SBATCH --output=/hkfs/work/workspace_haic/scratch/km6079-diffrl/reppo/outputs/028_mjx_hum_32steps_extend/%x_%A_%a.out
##SBATCH --error=/hkfs/work/workspace_haic/scratch/km6079-diffrl/reppo/outputs/028_mjx_hum_32steps_extend/%x_%A_%a.err
...
### Juwels
#SBATCH --output=/p/home/jusers/thilges1/juwels/PROJECT_hai_1311/thilges/diffrl/reppo/outputs/028_mjx_hum_32steps_extend/%x_%A_%a.out
#SBATCH --error=/p/home/jusers/thilges1/juwels/PROJECT_hai_1311/thilges/diffrl/reppo/outputs/028_mjx_hum_32steps_extend/%x_%A_%a.err
...
### Kluster
##SBATCH --output=/home/i53/mitarbeiter/thilges/rl-soc/reppo/outputs/028_mjx_hum_32steps_extend/%x_%A_%a.out
##SBATCH --error=/home/i53/mitarbeiter/thilges/rl-soc/reppo/outputs/028_mjx_hum_32steps_extend/%x_%A_%a.err
...
# SWEEP Params
# ==============================================================================
BASE_OVERRIDE="-cn reppo_pis +run=028_mjx_hum_32steps_extend/config"
...
ABLATION_OVERRIDES=(
    ...
    "seed=8"
    "seed=9"
    "seed=0 hyperparameters.diffusion.diff_steps=4"
    "seed=1 hyperparameters.diffusion.diff_steps=4"
    "seed=2 hyperparameters.diffusion.diff_steps=4"
    "seed=3 hyperparameters.diffusion.diff_steps=4"
    "seed=4 hyperparameters.diffusion.diff_steps=4"
    "seed=5 hyperparameters.diffusion.diff_steps=4"
    "seed=6 hyperparameters.diffusion.diff_steps=4"
    "seed=7 hyperparameters.diffusion.diff_steps=4"
    "seed=8 hyperparameters.diffusion.diff_steps=4"
    "seed=9 hyperparameters.diffusion.diff_steps=4"
)
...
export WANDB_DIR=/p/home/jusers/thilges1/juwels/PROJECT_hai_1311/thilges/diffrl/reppo/outputs/028_mjx_hum_32steps_extend/ # for juwels
mkdir -pv $WANDB_DIR
