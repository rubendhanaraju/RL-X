...
### Horeka
##SBATCH --output=/hkfs/work/workspace/scratch/km6079-diffrl/reppo/outputs/054_mjx_reppo_bench/%x_%A_%a.out
##SBATCH --error=/hkfs/work/workspace/scratch/km6079-diffrl/reppo/outputs/054_mjx_reppo_bench/%x_%A_%a.err
...
### HAICORE
##SBATCH --output=/hkfs/work/workspace_haic/scratch/km6079-diffrl/reppo/outputs/054_mjx_reppo_bench/%x_%A_%a.out
##SBATCH --error=/hkfs/work/workspace_haic/scratch/km6079-diffrl/reppo/outputs/054_mjx_reppo_bench/%x_%A_%a.err
...
### Juwels
#SBATCH --output=/p/home/jusers/celik5/juwels/PROJECT_hai_1316/thilges/reppo/outputs/054_mjx_reppo_bench/%x_%A_%a.out
#SBATCH --error=/p/home/jusers/celik5/juwels/PROJECT_hai_1316/thilges/reppo/outputs/054_mjx_reppo_bench/%x_%A_%a.err
...
### Kluster
##SBATCH --output=/home/i53/mitarbeiter/thilges/rl-soc/reppo/outputs/054_mjx_reppo_bench/%x_%A_%a.out
##SBATCH --error=/home/i53/mitarbeiter/thilges/rl-soc/reppo/outputs/054_mjx_reppo_bench/%x_%A_%a.err
...
# SWEEP Params
# ==============================================================================
BASE_OVERRIDE="-cn reppo +run=054_mjx_reppo_bench/config"
...
export WANDB_DIR=/p/home/jusers/celik5/juwels/PROJECT_hai_1316/thilges/reppo/outputs/054_mjx_reppo_bench/ # for juwels
mkdir -pv $WANDB_DIR
