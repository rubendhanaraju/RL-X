...
def submit_job(
    ...
    if seed == BASE_SEED:
        ...
        checkpoint_dir = "./reppo_checkpoints"
        render_dir = "./videos"
...
def main():
    ...
    print(f"Submitting {len(args.tasks)} ManiSkill tasks with {args.seeds} seeds each")
