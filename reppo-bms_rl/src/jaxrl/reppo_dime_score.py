...
def make_train_fn(
    ...
    def train_fn(key: PRNGKey, cfg: ReppoConfig) -> tuple[SACTrainState, dict]:
        def train_eval_step(key, train_state, train_actor_state, train_actor_target_state, train_ent_coef_state, train_kl_coef_state, sampler=None, kl_diver=None):
            ...
            return (train_state, train_actor_state, train_actor_target_state, train_ent_coef_state, train_kl_coef_state), metrics, all_rollout_actions, eval_actions
        ...
        def loop_body(
            ...
            (train_state, train_actor_state, train_actor_target_state, train_ent_coef_state, train_kl_coef_state), metrics, all_rollout_actions, eval_actions = jax.vmap(train_eval_step_with_sampler_and_kl_diver)(
        ...
        train_state, train_actor_state, train_actor_target_state, train_ent_coef_state, train_kl_coef_state = jax.vmap(make_init (cfg, env, env_params))(
