...
from rl_x.algorithms.reppo_dime.flax_full_jit.utils import MLP, hl_gauss, select_observation
...
def get_critic(config, env):
    ...
    raise ValueError("RePPO-DIME flax_full_jit only supports flat-value observations.")
