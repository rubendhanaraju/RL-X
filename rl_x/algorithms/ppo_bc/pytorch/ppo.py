...
from rl_x.algorithms.ppo_bc.pytorch.general_properties import GeneralProperties
from rl_x.algorithms.ppo_bc.pytorch.policy import get_policy
from rl_x.algorithms.ppo_bc.pytorch.critic import get_critic
from rl_x.algorithms.ppo_bc.pytorch.batch import Batch
    ...
    def train(self):
        ...
        def critic_loss_fn(states, returns):
            with autocast(device_type="cuda", dtype=torch.bfloat16, enabled=self.bf16_mixed_precision_training):
                ...
                critic_loss = self.critic_coef * (0.5 * (new_value - returns) ** 2).mean()
        ...
        while global_step < self.total_timesteps:
            ...
            for epoch in range(self.nr_epochs):
                ...
                for start in range(0, self.batch_size, self.minibatch_size):
                    ...
                    # Losses
                    pg_loss, entropy_loss, approx_kl_div, clip_fraction, policy_grad_norm = \
