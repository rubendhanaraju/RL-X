...
from rl_x.algorithms.ppo_bc.flax_full.general_properties import GeneralProperties
from rl_x.algorithms.ppo_bc.flax_full.policy import get_policy
from rl_x.algorithms.ppo_bc.flax_full.critic import get_critic
from rl_x.algorithms.ppo_bc.flax_full.batch import Batch
...
class PPO:
    def __init__(self, config, train_env, eval_env, run_path, writer):
        ...
        self.bc_loss_coef = config.algorithm.bc_loss_coef
