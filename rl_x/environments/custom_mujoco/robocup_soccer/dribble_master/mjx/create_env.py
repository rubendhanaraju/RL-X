...
from rl_x.environments.custom_mujoco.robocup_soccer.dribble_master.mjx.environment import DribbleMasterEnv
from rl_x.environments.custom_mujoco.robocup_soccer.dribble_master.mjx.general_properties import GeneralProperties
