...
from rl_x.environments.custom_mujoco.robocup_soccer.dribble_master.mjx.state import State
from rl_x.environments.custom_mujoco.robocup_soccer.dribble_master.mjx.box_space import BoxSpace
from rl_x.environments.custom_mujoco.robocup_soccer.dribble_master.mjx.viewer import MujocoViewer
from rl_x.environments.custom_mujoco.robocup_soccer.dribble_master.mjx.control_functions.handler import get_control_function
from rl_x.environments.custom_mujoco.robocup_soccer.dribble_master.mjx.command_functions.handler import get_command_function
from rl_x.environments.custom_mujoco.robocup_soccer.dribble_master.mjx.gait_manager_functions.handler import get_gait_manager_function
from rl_x.environments.custom_mujoco.robocup_soccer.dribble_master.mjx.domain_randomization.initial_state_functions.handler import get_initial_state_function
from rl_x.environments.custom_mujoco.robocup_soccer.dribble_master.mjx.sampling_functions.handler import get_sampling_function
from rl_x.environments.custom_mujoco.robocup_soccer.dribble_master.mjx.reward_functions.handler import get_reward_function
from rl_x.environments.custom_mujoco.robocup_soccer.dribble_master.mjx.termination_functions.handler import get_termination_function
from rl_x.environments.custom_mujoco.robocup_soccer.dribble_master.mjx.domain_randomization.action_delay_functions.handler import get_domain_randomization_action_delay_function
from rl_x.environments.custom_mujoco.robocup_soccer.dribble_master.mjx.domain_randomization.mujoco_model_functions.handler import get_domain_randomization_mujoco_model_function
from rl_x.environments.custom_mujoco.robocup_soccer.dribble_master.mjx.domain_randomization.seen_robot_functions.handler import get_domain_randomization_seen_robot_function
from rl_x.environments.custom_mujoco.robocup_soccer.dribble_master.mjx.domain_randomization.unseen_robot_functions.handler import get_domain_randomization_unseen_robot_function
from rl_x.environments.custom_mujoco.robocup_soccer.dribble_master.mjx.domain_randomization.perturbation_functions.handler import get_domain_randomization_perturbation_function
from rl_x.environments.custom_mujoco.robocup_soccer.dribble_master.mjx.domain_randomization.observation_noise_functions.handler import get_observation_noise_function
...
class DribbleMasterEnv:
    ...
    def _step(self, state, action):
        ...
        terminated = self.termination_function.should_terminate(state.internal_state)
    ...
    def get_observation(self, data, mjx_model, internal_state, key, action):
        ...
        critic_relative_ball_position = self.relative_ball_position_base(data, internal_state, critic_base_pos_world, critic_base_yaw)
        ...
        observation = observation.at[self.critic_relative_ball_position_true_obs_idx].set(jnp.clip(observation[self.critic_relative_ball_position_true_obs_idx] / self.ball_spawn_radius, -1.0, 1.0))
        observation = observation.at[self.critic_base_position_world_true_obs_idx].set(jnp.clip(observation[self.critic_base_position_world_true_obs_idx] / self.ball_spawn_radius, -1.0, 1.0))
    ...
    def get_observation_space(self):
        ...
        current_observation_idx += 3
        self.critic_relative_ball_position_true_obs_idx = jnp.array([current_observation_idx + i for i in range(3)])
        current_observation_idx += 3
