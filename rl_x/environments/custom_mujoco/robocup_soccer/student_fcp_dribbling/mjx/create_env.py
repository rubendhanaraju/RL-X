...
from rl_x.environments.custom_mujoco.robocup_soccer.student_fcp_dribbling.mjx.environment import StudentFCPDribblingEnv
...
def create_train_and_eval_env(config):
    ...
    train_env = StudentFCPDribblingEnv(
    ...
    eval_env = StudentFCPDribblingEnv(
        robot_config=robot_config,
        runner_mode=config.runner.mode,
        render=config.environment.render,
        env_config=config.environment,
