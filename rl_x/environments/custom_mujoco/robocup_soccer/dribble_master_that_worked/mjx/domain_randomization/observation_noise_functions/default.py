...
class DefaultDRObservationNoise:
    def __init__(self, env):
        ...
        self.ball_position_noise = env.env_config["domain_randomization"]["observation_noise"].get("ball_position", 0.0)
    ...
    def init_attributes(self):
        ...
        self.relative_ball_position_obs_idx = self.env.relative_ball_position_obs_idx
    ...
    def modify_observation(self, internal_state, observation, key):
        ...
        observation = observation.at[self.relative_ball_position_obs_idx].set(observation[self.relative_ball_position_obs_idx] + internal_state["env_curriculum_coeff"] * jax.random.uniform(noise_key6, shape=(len(self.relative_ball_position_obs_idx),), minval=-self.ball_position_noise, maxval=self.ball_position_noise))
