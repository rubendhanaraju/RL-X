...
from rl_x.environments.custom_mujoco.robocup_soccer.moving_target_master.mjx.environment import MovingTargetMasterEnv
from rl_x.environments.custom_mujoco.robocup_soccer.moving_target_master.mjx.general_properties import GeneralProperties
...
def create_train_and_eval_env(config):
    ...
    train_env = MovingTargetMasterEnv(
    ...
    eval_env = MovingTargetMasterEnv(
        robot_config=robot_config,
        runner_mode=config.runner.mode,
        render=config.environment.render,
        env_config=config.environment,
