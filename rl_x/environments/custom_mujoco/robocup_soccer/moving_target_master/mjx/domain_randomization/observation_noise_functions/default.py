...
class DefaultDRObservationNoise:
    def __init__(self, env):
        ...
        self.point_position_noise = env.env_config["domain_randomization"]["observation_noise"].get("point_position", 0.0)
    ...
    def init_attributes(self):
        ...
        self.relative_point_position_obs_idx = self.env.relative_point_position_obs_idx


    def modify_observation(self, internal_state, observation, key):
        noise_key1, noise_key2, noise_key3, noise_key4, noise_key5, noise_key6 = jax.random.split(key, 6)
        ...
        observation = observation.at[self.relative_point_position_obs_idx].set(observation[self.relative_point_position_obs_idx] + internal_state["env_curriculum_coeff"] * jax.random.uniform(noise_key6, shape=(len(self.relative_point_position_obs_idx),), minval=-self.point_position_noise, maxval=self.point_position_noise))
