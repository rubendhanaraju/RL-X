...
from rl_x.environments.custom_mujoco.robocup_soccer.locomotion_ball_residual.mjx.environment import (
    ResidualLocomotionBallEnv,
)
...
def create_train_and_eval_env(config):
    ...
    train_env = ResidualLocomotionBallEnv(
    ...
    eval_env = ResidualLocomotionBallEnv(
        robot_config=robot_config,
        runner_mode=config.runner.mode,
        render=config.environment.render,
        env_config=config.environment,
