...
from rl_x.environments.custom_mujoco.robocup_soccer.locomotion.mjx.environment import (
    LocomotionEnv,
)
from rl_x.environments.custom_mujoco.robocup_soccer.locomotion_residual.mjx.general_properties import (
    GeneralProperties,
)
from rl_x.environments.custom_mujoco.robocup_soccer.locomotion_residual.mjx.reward import (
    ResidualRunReward,
)
...
class FixedBelowHeightTermination:
    ...
    def should_terminate(self, internal_state):
        ...
        return internal_state["robot_imu_height_over_ground"] < min_height


class ResidualLocomotionEnv(LocomotionEnv):
    def __init__(self, robot_config, runner_mode, render, env_config, nr_envs):
        ...
        self.reward_function = ResidualRunReward(self)
    ...
    def get_observation(self, data, mjx_model, internal_state, key, action):
        ...
        observation = self.observation_noise_function.modify_observation(
            internal_state, observation, key
        )
