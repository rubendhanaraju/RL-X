...
class DefaultReward:
    ...
    def reward_and_info(self, data, mjx_model, internal_state, action, info):
        ...
        # Total reward
        tracking_reward = tracking_xy_velocity_command_reward + tracking_yaw_velocity_command_reward + feet_phase_reward + ball_velocity_tracking_reward + chasing_ball_reward + com_chasing_ball_reward + close_ball_band_reward + yaw_to_ball_reward + yaw_alignment_reward + active_sensing_reward
