...
from rl_x.environments.custom_mujoco.robocup_soccer.student_dribbling.mjx.default_config import get_config
from rl_x.environments.custom_mujoco.robocup_soccer.student_dribbling.mjx.general_properties import GeneralProperties


ROBOCUP_SOCCER_STUDENT_DRIBBLING_MJX_ENV = extract_environment_name_from_file(__file__)
register_environment(ROBOCUP_SOCCER_STUDENT_DRIBBLING_MJX_ENV, get_config, create_train_and_eval_env, GeneralProperties)
