...
from rl_x.environments.custom_mujoco.robocup_soccer.fcp_walk_policy_dribbling.mjx.environment import WalkPolicyDribblingEnv
...
def create_train_and_eval_env(config):
    ...
    train_env = WalkPolicyDribblingEnv(
    ...
    eval_env = WalkPolicyDribblingEnv(
        robot_config=robot_config,
        runner_mode=config.runner.mode,
        render=config.environment.render,
        env_config=config.environment,
