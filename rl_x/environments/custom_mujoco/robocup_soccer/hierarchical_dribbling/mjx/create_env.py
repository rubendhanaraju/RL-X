...
from rl_x.environments.custom_mujoco.robocup_soccer.hierarchical_dribbling.mjx.environment import HierarchicalDribblingEnv
...
def create_train_and_eval_env(config):
    ...
    train_env = HierarchicalDribblingEnv(
    ...
    eval_env = HierarchicalDribblingEnv(
        robot_config=robot_config,
        runner_mode=config.runner.mode,
        render=config.environment.render,
        env_config=config.environment,
