class BelowHeightTermination:
    ...
    def should_terminate(self, internal_state):
        curriculum_below_height = internal_state["robot_imu_height_over_ground"] < ((1 - internal_state["env_curriculum_coeff"]) * self.height_percentage_threshold * internal_state["robot_nominal_imu_height_over_ground"])
