...
from rl_x.environments.custom_mujoco.robocup_soccer.point_master.mjx.environment import PointMasterEnv
from rl_x.environments.custom_mujoco.robocup_soccer.point_master.mjx.general_properties import GeneralProperties
