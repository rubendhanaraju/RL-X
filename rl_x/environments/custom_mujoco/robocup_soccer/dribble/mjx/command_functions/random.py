...
class RandomCommands:
    def __init__(self, env):
        ...
        self.sample_yaw_velocity = self.env.env_config["command"].get("sample_yaw_velocity", True)
    ...
    def get_next_command(self, internal_state, should_sample_commands, subkey):
        ...
        goal_velocities = goal_velocities.at[2].set(jnp.where(self.sample_yaw_velocity, goal_velocities[2], 0.0))
