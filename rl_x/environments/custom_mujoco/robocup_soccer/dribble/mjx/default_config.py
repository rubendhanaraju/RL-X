...
def get_config(environment_name):
    config = {
        ...
        # Stage 1 trains from scratch and reuses the original locomotion
        # sub-curriculum. Stage 2 overrides this to keep the locomotion
        # curriculum at its fully solved value.
        "legacy_env_curriculum": {
            "enabled": True,
            "fixed_coeff": 1.0,
        },
        ...
        "reward": {
            ...
            "chasing_coeff": 1.0,
            "chasing_distance_coeff": 2.0,
            "projected_ball_velocity_coeff": 1.5,
            "projected_ball_velocity_temperature": 1.0,
            "yaw_alignment_coeff": 0.2,
            "yaw_alignment_error_coeff": 2.0,
        ...
        "dribble": {
            "ball_reset_x_range": [0.4, 0.9],
            "ball_reset_y_range": [-0.3, 0.3],
            "ball_position_observation_scale": 5.0,
            "ball_velocity_observation_scale": 5.0,
        },
        "dribble_curriculum": {
            "stage": 1,
            "stage_1": {
                "legacy_env_curriculum_enabled": True,
                "ball_reset_x_range": [9.5, 10.0],
                "ball_reset_y_range": [-1.0, 1.0],
            ...
            "stage_2": {
                "legacy_env_curriculum_enabled": False,
                "legacy_env_curriculum_fixed_coeff": 1.0,
                "ball_reset_x_range": [0.4, 1.8],
                "ball_reset_y_range": [-1.0, 1.0],
                "ball_distance_threshold": 3.0,
                "tracking_xy_velocity_command_coeff": 0.0,
                "tracking_yaw_velocity_command_coeff": 0.0,
