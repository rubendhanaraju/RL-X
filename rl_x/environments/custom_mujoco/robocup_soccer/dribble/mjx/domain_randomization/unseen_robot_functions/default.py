...
class DefaultDRUnseenRobotFunction:
    def __init__(self, env):
        ...
        self.nr_joint_dampings = self.env.nr_actuator_joints
        self.nr_joint_armatures = self.env.nr_actuator_joints
        self.nr_joint_stiffnesses = self.env.nr_actuator_joints
        self.nr_joint_frictionlosses = self.env.nr_actuator_joints
