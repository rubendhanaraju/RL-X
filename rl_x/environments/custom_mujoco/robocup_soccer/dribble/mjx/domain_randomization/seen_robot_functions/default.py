...
class DefaultDRSeenRobotFunction:
    def __init__(self, env):
        ...
        self.default_jnt_pos = self.env.initial_mjx_model.jnt_pos[self.env.actuator_joint_mask_joints]
        self.default_joint_rotation_axes = self.env.initial_mjx_model.jnt_axis[self.env.actuator_joint_mask_joints]
        ...
        self.default_joint_dampings = self.env.initial_mjx_model.dof_damping[self.env.actuator_joint_mask_qvel]
        self.default_joint_armatures = self.env.initial_mjx_model.dof_armature[self.env.actuator_joint_mask_qvel]
        self.default_joint_stiffnesses = self.env.initial_mjx_model.jnt_stiffness[self.env.actuator_joint_mask_joints]
        self.default_joint_frictionlosses = self.env.initial_mjx_model.dof_frictionloss[self.env.actuator_joint_mask_qvel]
    ...
    def sample(self, internal_state, mjx_model, data, should_randomize, key):
        ...
        joint_positions = mjx_model.jnt_pos.at[self.env.actuator_joint_mask_joints].set(self.default_jnt_pos * body_size_factor)
        ...
        jnt_axis = mjx_model.jnt_axis.at[self.env.actuator_joint_mask_joints].set(rotated_joint_rotation_axes)
        ...
        actuator_joint_ranges = self.default_joint_ranges[self.env.actuator_joint_mask_joints - 1] + env_curriculum_coeff * jax.random.uniform(keys[17], minval=-self.add_joint_range, maxval=self.add_joint_range, shape=(self.env.nr_actuator_joints, 2))
        joint_ranges = self.default_joint_ranges.at[self.env.actuator_joint_mask_joints - 1].set(actuator_joint_ranges)
        ...
        dof_damping = mjx_model.dof_damping.at[self.env.actuator_joint_mask_qvel].set(seen_joint_dampings * internal_state["joint_damping_noise_factors"])
        ...
        dof_armature = mjx_model.dof_armature.at[self.env.actuator_joint_mask_qvel].set(seen_joint_armatures * internal_state["joint_armature_noise_factors"])
        ...
        jnt_stiffness = mjx_model.jnt_stiffness.at[self.env.actuator_joint_mask_joints].set(seen_joint_stiffnesses * internal_state["joint_stiffness_noise_factors"])
        ...
        dof_frictionloss = mjx_model.dof_frictionloss.at[self.env.actuator_joint_mask_qvel].set(seen_joint_frictionlosses * internal_state["joint_friction_loss_noise_factors"])
