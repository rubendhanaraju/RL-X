...
from rl_x.environments.custom_mujoco.robocup_soccer.dribbling_residual.mjx.environment import ResidualDribbleMasterEnv
...
def create_train_and_eval_env(config):
    ...
    train_env = ResidualDribbleMasterEnv(
    ...
    eval_env = ResidualDribbleMasterEnv(
        robot_config=robot_config,
        runner_mode=config.runner.mode,
        render=config.environment.render,
        env_config=config.environment,
