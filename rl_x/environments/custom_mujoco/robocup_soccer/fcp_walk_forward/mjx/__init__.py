...
try:
    ROBOCUP_SOCCER_FCP_WALK_FORWARD_MJX_ENV = extract_environment_name_from_file(
        __file__
    )
except IndexError:
    ROBOCUP_SOCCER_FCP_WALK_FORWARD_MJX_ENV = (
        "custom_mujoco.robocup_soccer.fcp_walk_forward.mjx"
    )
